...
## 確認事項
1. Gadget Bridge内の設定 → 開発者用設定 → Intent API → 一番下のデバッグコマンドを許可<br>が許可されていることを確認してください。
2. 本体設定 → アプリ → Gadget Bridge → アプリのアクセス許可 → その他の権限 → Run commands in Termux environment<br>が許可されていることを確認してください。
...
<img src="./img/termux_install1.png" alt="termux_install1" width="300"> <img src="./img/termux_install2.png" alt="termux_install2" width="300">
...
---
**Author: [sugiura](iruru0422)** | Date: 2026-09-15
